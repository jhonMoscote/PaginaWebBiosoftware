...
@Component({
  selector: 'app-equiposdadosbaja',
  templateUrl: './equiposdadosbaja.component.html',
  styleUrls: ['./equiposdadosbaja.component.css']
})
export class EquiposdadosbajaComponent implements OnInit {
